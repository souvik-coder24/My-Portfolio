  ...
  return (
    <div className={styles.about}>
      ...
      <div className={styles.right} data-aos="fade-left">
        ...
        <p>
          {isMobile ? (
            "Hello! I'm Souvik Das, a frontend developer who graduated from JIS College of Engineering, Kalyani in 2022 with a degree in Information Technology. As a fresher, I have a strong foundation in HTML5, CSS3, Bootstrap, Tailwind CSS, JavaScript, Java, React.js, Node.js, Git, and GitHub. Recently, I've also gained proficiency in SASS for enhanced CSS styling, Firebase for backend services, Appwrite for backend services and Netlify for deployment. My personal projects have fueled my passion for creating user-friendly and visually appealing web interfaces. I am eager to apply my skills to real-world projects, continuously learn, and grow in the dynamic field of web development. Check out my portfolio and GitHub for examples of my work and to see how I can contribute to your team."
          ) : (
            <Typewriter
